...
using JackspajfsRandomStuff.Enemies.Space;
using Terraria;
//using Terraria.ID;
...
{
    public class BlackHoleBannerTile : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<BlackHoleBanner>());
        }
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            if (closer)
            {
                ...
                Main.SceneMetrics.NPCBannerBuff[ModContent.NPCType<BlackHole>()] = true;
            }
        }
    }
}