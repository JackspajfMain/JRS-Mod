...
{
    public class RedSquidBannerTile : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<RedSquidBanner>());
        }
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            if (closer)
            {
                ...
                Main.SceneMetrics.NPCBannerBuff[ModContent.NPCType<RedSquid>()] = true;
            }
        }
    }
}