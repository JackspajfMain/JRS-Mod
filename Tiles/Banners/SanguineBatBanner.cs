...
using JackspajfsRandomStuff.Enemies.Bats;
using Terraria;
//using Terraria.ID;
...
{
    public class SanguineBatBannerTile : ModTile
    {
        ...
        {
            Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 48, ModContent.ItemType<SanguineBatBanner>());
        }
        ...
        public override void NearbyEffects(int i, int j, bool closer)
        {
            if (closer)
            {
                ...
                Main.SceneMetrics.NPCBannerBuff[ModContent.NPCType<SanguineBat>()] = true;
            }
        }
    }
}